// clientes.js
// JavaScript for clientes.html to handle table filtering and delete confirmations
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (table) {
        ...
        filterInput.placeholder = 'Buscar clientes por nombre o correo...';
    ...
    // Confirm deletion
    const deleteLinks = document.querySelectorAll('a[href*="/clientes/eliminar/"]');
